...
die Teil des
[DFG-Exzellenzclusters Math+](https://mathplus.de) ist.
Er erwarb seinen Doktortitel (2024) und seinen
Masterabschluss (2018) in Mathematik an der TU Berlin, jeweils mit Auszeichnung,
unter der Betreuung von [Alexander Bobenko](https://page.math.tu-berlin.de/~bobenko/).
Der Fokus seiner Forschung liegt auf der
diskreten Differentialgeometrie (DDG) mit den Schwerpunkten diskrete konforme
Äquivalenz, Kreispackungen und -muster sowie deren Verbindungen zur Geometrie von
Polyedern im hyperbolischen 3-Raum.
